package customer.capshowcase.handlers;
...
public class Z_G_BLC_MTORDER_DPC_EXT implements EventHandler {
    ...
    @Before(event = { CqnService.EVENT_CREATE }, entity = "ZGBLMTORDER_SRV.ENTITY001Set")
    ...
    @After(event = { CqnService.EVENT_CREATE }, entity = "ZGBLMTORDER_SRV.ENTITY001Set")
    ...
    @Before(event = { CqnService.EVENT_UPDATE }, entity = "ZGBLMTORDER_SRV.ENTITY001Set")
    ...
    @After(event = { CqnService.EVENT_UPDATE }, entity = "ZGBLMTORDER_SRV.ENTITY001Set")
